...
export const env = {
  ...
  judge0PollMs: Number(process.env.JUDGE0_POLL_MS || 250),
  judge0PollTimeout: Number(process.env.JUDGE0_POLL_TIMEOUT || Math.max(Number(process.env.EXECUTION_TIMEOUT || 5000) * 2, 15000)),
